<template>
  <div id="console">
    ...
    <img
      ...
      src="/icons/console/bolt-up-left.webp"
    />
    <img
      id="corner"
      alt=""
      class="absolute top-2 right-2 opacity-70"
      src="/icons/console/bolt-up-right.webp"
    />
    <img
      id="corner"
      alt=""
      class="absolute bottom-2 left-2 opacity-70"
      src="/icons/console/bolt-down-left.webp"
    />
    <img
      id="corner"
      alt=""
      class="absolute bottom-2 right-2 opacity-70"
      src="/icons/console/bolt-down-right.webp"
    />
        ...
        <div id="instructions" class="font-fira_retina text-sm text-white">
          ...
          >
            <button id="console-button" class="button-up" @click="move('up')">
              <img alt="" src="/icons/console/arrow-button.webp" />
            </button>
            ...
            <div class="grid grid-cols-3 gap-1">
              ...
              >
                <img
                  alt=""
                  class="-rotate-90"
                  src="/icons/console/arrow-button.webp"
                />
              </button>
